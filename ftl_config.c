...
void InitFTL()
{
    ...
    pr_info("MONITOR_START_ADDR:0x%x",MONITOR_START_ADDR);
    pr_info("MONITOR_END_ADDR:0x%x",MONITOR_END_ADDR);
    pr_info("CH_INFO_START_ADDR:0x%x",CH_INFO_START_ADDR);
    pr_info("CH_INFO_END_ADDR:0x%x",CH_INFO_END_ADDR);
    pr_info("NMC_FILENAME_DATA_BUFFER_END_ADDR:%x",NMC_FILENAME_DATA_BUFFER_END_ADDR);
