...
// In the command "get_partial_result", if there is valid data in the firmware, 
// the requestCode will be set to "REQ_CODE_NMC_INFERENCE_READ". 
// If there is no valid data, the requestCode will be set to "REQ_CODE_NMC_SPECIAL_HEADER"
#define REQ_CODE_NMC_INFERENCE_READ 0xB6
#define REQ_CODE_NMC_SPECIAL_HEADER 0xB3
#define REQ_CODE_WRITE_BUFFER       0xB4
#define REQ_CODE_VERIFY_IMG         0xB5
#define REQ_CODE_GET_MAPPING_TABLE  0xB2
/**
