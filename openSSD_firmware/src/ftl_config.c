...
void InitFTL()
{
    ...
    pr_info("NMC_BUFFERS_END_ADDR:%x",NMC_BUFFERS_END_ADDR);
    pr_info("NMC nmcMappingTableBufPtr address %x",NMC_MAPPING_TABLE_BUFFER_ADDR);

    pr_info("NMC_CH_MAPPING_PREFIX_INFO_BYTES:%d",NMC_CH_MAPPING_PREFIX_INFO_BYTES);
    pr_info("NMC_CH_MAPPING_LIST_ENTRIES:%d",NMC_CH_MAPPING_LIST_ENTRIES);
    pr_info("NMC_CH_MAPPING_POSTFIX_INFO_BYTES:%d",NMC_CH_MAPPING_POSTFIX_INFO_BYTES);
    pr_info("NMC_FILENAME_MAX_BYTES:%d",NMC_FILENAME_MAX_BYTES);
    pr_info("BYTES_PER_SPARE_REGION_OF_SLICE:%d",BYTES_PER_SPARE_REGION_OF_SLICE);
}
