...
#define IO_NVM_NMC_VERIFY_IMG           0xC4
#define IO_NVM_GET_MAPPING_TABLE        0xC8
#define IO_NVM_FIRMWARE_READ_MAPPING    0xC6

#define IO_NVM_GET_PARTIAL_STATUS 0xC7
#define IO_NVM_NMC_INFERENCE_READ 0xC5
#define IO_NVM_NMC_WRITE     0xC9 // write packet (distribute to all FCs)
#define IO_NVM_WRITE_BUFFER  0xCA
...
#define SC_VENDOR_GET_PARTIAL_CONTINUE             0x08
#define SC_VENDOR_GET_PARTIAL_END                  0x09
#define SC_VENDOR_PARTIAL_BUFFER_EMPTY             0x0A
#define SC_VENDOR_GET_MAPPING_TABLE_FAID           0x0B
