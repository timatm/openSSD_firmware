                     ...
                     unsigned int autoCompletion)
{
    ...
    // pr_debug("set_auto_tx_dma info");
    // pr_debug("set_auto_tx_dma cmdSlotTag:%x",cmdSlotTag);
    // pr_debug("set_auto_tx_dma dma index:%x",cmd4KBOffset);
    // pr_debug("set_auto_tx_dma device address:%x",devAddr);
    // pr_debug("set_auto_tx_dma host PCIe H address:%x",hostDmaReg.pcieAddrH);
    // pr_debug("set_auto_tx_dma host PCIe L address:%x",hostDmaReg.pcieAddrL);
